 ...
 * =========================LICENSE_END==================================
 */
package io.github.ericmedvet.robotevo2d.main.tasks.holemotion;
...
public class Holemotion implements Task<Supplier<EmbodiedAgent>, Outcome<AgentsObservation>> {
  ...
  public Holemotion(double duration, Terrain terrain, double initialXGap, double initialYGap) {
